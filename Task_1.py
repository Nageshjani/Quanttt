...
til_date=dt.datetime(2022,12,31) 


ld = dt.datetime(2021, 1, 1, tzinfo=pytz.utc)
td = dt.datetime(2022, 12, 31, tzinfo=pytz.utc)
#til_date=dt.datetime.now()


while True:
    print(last_datetime)
    if ld>td:break
    new_df = get_bybit_bars("BTCUSD", 15, last_datetime, til_date)
    if new_df is None:
        break
